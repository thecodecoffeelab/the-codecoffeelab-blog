        ...
        <article class="flex flex-col shadow my-4">
            ...
            <div class="bg-white flex flex-col justify-start p-6">
                ...
                <p href="#" class="text-sm pb-8">
                    By <a href="https://www.thecodecoffeelab.com" target="_blank" class="font-semibold hover:text-gray-800">{{$post->user->name}} NDIAYE</a>, Published on
        ...
        <div class="w-full flex pt-6">
                ...
                @if($prev)
                    <a href="{{route('view', $prev)}}"
                       class="block w-full bg-white shadow hover:shadow-md text-left p-6">
                        <p class="text-lg text-amber-800 font-bold flex items-center">
            ...
            <div class="w-1/2">
                <a href="{{route('view', $next)}}" class="block w-full bg-white shadow hover:shadow-md text-right p-6">
                    <p class="text-lg text-amber-800 font-bold flex items-center justify-end">Next
                        <i
